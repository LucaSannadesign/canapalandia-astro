---
title: "THC, CBD e tracce nei controlli: cosa sapere in Italia"
description: "THC, CBD, limiti, tracce e controlli: guida semplice per capire cosa può creare problemi, come leggere etichette e certificati e quali errori evitare."
...
Il **CBD non è THC**: sono cannabinoidi diversi e nei controlli non vanno confusi. Anche **tracce residue** o **documentazione assente** (etichetta, COA) possono creare problemi, a seconda di prodotto e contesto. **Etichette e certificati di analisi** aiutano a verificare cosa contiene un prodotto; il **comportamento dell’utente** e il **contesto del controllo** (uso dichiarato, coerenza tra presentazione e analisi) incidono sul quadro. Questo articolo è **informativo** e non sostituisce consulenza legale personalizzata.
...
Il **certificato di analisi** (COA, Certificate of Analysis) riporta cannabinoidi misurati, metodo e limiti di rilevazione. Non è una “patente” automatica di liceità, ma aiuta a confrontare etichetta e composizione reale. In assenza di COA aggiornato e coerente con il lotto, aumenta il rischio di ambiguità in un controllo.
...
- [Cannabis light in Italia: cosa conta davvero in caso di controlli](/blog/cannabis-light-italia-cosa-conta-davvero-in-caso-di-controlli/)
- [Cannabis light e CBD in Italia nel 2026](/blog/cannabis-light-cbd-legale-italia-2026/)
- [Decreto Sicurezza e filiera della canapa: cosa cambia davvero](/blog/filiera-canapa-sfida-decreto-sicurezza/)
- [Novel Food e CBD: cosa significa davvero](/blog/cbd-novel-food-ue-2026/)
...
### Il CBD può creare problemi nei controlli?

Il CBD da solo non equivale al THC, ma un prodotto “solo CBD” può comunque sollevare domande se l’etichetta è vaga, manca la documentazione (COA) o emergono tracce di THC o incoerenze tra uso dichiarato e analisi. Il quadro dipende da categoria, contesto e comportamento: non esiste una risposta sì/no valida per ogni situazione.
